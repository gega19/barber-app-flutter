...
abstract class AppointmentRemoteDataSource {
  ...
  Future<List<AppointmentModel>> getBarberQueue(
    String barberId, {
    DateTime? date,
  });
...
class AppointmentRemoteDataSourceImpl implements AppointmentRemoteDataSource {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw ServerException(
          response.data['message'] ?? 'Error al obtener citas',
        );
      }
      ...
      throw ServerException(
        e.response?.data['message'] ?? 'Error de red al obtener citas',
      );
    } catch (e) {
  ...
  Future<AppointmentModel> getAppointmentById(String id) async {
    try {
      final response = await dio.get(
        '${AppConstants.baseUrl}/api/appointments/$id',
      );
      ...
      if (response.statusCode == 200) {
        ...
        throw ServerException(
          response.data['message'] ?? 'Error al obtener cita',
        );
      }
    } on DioException catch (e) {
      appLogger.e('GetAppointmentById error: ${e.message}', error: e);
      if (e.type == DioExceptionType.connectionTimeout ||
          e.type == DioExceptionType.receiveTimeout) {
        throw NetworkException('Error de conexión. Verifica tu internet.');
      }
      throw ServerException(
        e.response?.data['message'] ?? 'Error de red al obtener cita',
      );
    } catch (e) {
      appLogger.e('GetAppointmentById unexpected error: \$e', error: e);
      throw ServerException('Error inesperado al obtener cita');
    }
  }
  ...
  Future<List<AppointmentModel>> getBarberQueue(
    ...
    try {
      String url =
          '${AppConstants.baseUrl}/api/appointments/barber/$barberId/queue';
      ...
      if (response.statusCode == 200) {
        ...
        throw ServerException(
          response.data['message'] ?? 'Error al obtener cola del barbero',
        );
      }
    } on DioException catch (e) {
      ...
      throw ServerException(
        e.response?.data['message'] ?? 'Error de red al obtener cola',
      );
    } catch (e) {
  ...
  Future<AppointmentModel> createAppointment({
    ...
    try {
      ...
      if (e.response?.statusCode == 409) {
        ...
        throw ServerException(
          e.response?.data['message'] ?? 'Este horario ya está reservado',
        );
      }
      if (e.type == DioExceptionType.connectionTimeout ||
          e.type == DioExceptionType.receiveTimeout) {
      ...
      throw ServerException(
        e.response?.data['message'] ?? 'Error de red al crear cita',
      );
    } catch (e) {
  ...
  Future<void> cancelAppointment(String appointmentId) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw ServerException(
          response.data['message'] ?? 'Error al cancelar cita',
        );
      }
    } on DioException catch (e) {
      ...
      throw ServerException(
        e.response?.data['message'] ?? 'Error de red al cancelar cita',
      );
    } catch (e) {
  ...
  Future<void> markAsAttended(String appointmentId) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw ServerException(
          response.data['message'] ?? 'Error al marcar cita como atendida',
        );
      }
    } on DioException catch (e) {
      ...
      throw ServerException(
        e.response?.data['message'] ?? 'Error de red al marcar como atendida',
      );
    } catch (e) {
